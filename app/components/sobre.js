    ...
    return (
        <section className="bg-[url('/images/fundo_sobre.png')] bg-cover bg-center p-4">
            <div className="max-w-7xl m-auto flex flex-col gap-4">
                <h2 className="text-center text-primary font-bold">QUEM SOMOS</h2>
                ...
                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                    <Box img="/icons/equipe.png" title="EQUIPE ESPECIALIZADA" desc="Experiência em arquitetura e construção de alto padrão."/>
                    <Box img="/icons/visao.png" title="VISÃO INOVADORA" desc="Projetos que unem sofisticação e funcionalidade."/>
                    <Box img="/icons/foco.png" title="FOCO NO CLIENTE E NO INVESTIDOR" desc="Personalização para atender os sonhos e objetivos de lucro do investidor."/>
                </div>
            </div>
        </section>
    )
